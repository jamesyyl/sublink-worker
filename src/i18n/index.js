...
export const translations = {
  'zh-CN': {
    ...
    enableJameslabRouting: '启用 JamesLab 路由优化',
  ...
  'en-US': {
    ...
    enableJameslabRouting: 'Enable JamesLab Routing',
  ...
  'fa': {
    ...
    enableJameslabRouting: 'فعال کردن مسیریابی JamesLab',
  ...
  'ru': {
    ...
    enableJameslabRouting: 'Включить маршрутизацию JamesLab',
